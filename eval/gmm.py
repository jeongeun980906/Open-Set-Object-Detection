...
class GaussianMixture(torch.nn.Module):
    ...
    def load(self,path):
        ...
        self.mu.data = torch.FloatTensor(data['mu']).to('cuda')
        self.pi.data = torch.FloatTensor(data['pi']).to('cuda')
        self.var.data = torch.FloatTensor(data['var']).to('cuda')