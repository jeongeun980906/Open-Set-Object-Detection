...
def autolabel(images:ImageList,proposals:List[Instances],gt_instances:List[Instances],
    ...
    for image,proposal,gt in zip(images,proposals,gt_instances):
        ...
        ssl_score = compute_socre(top_score,patches,model,candidate,device,device_vit)
